...
客户服务系统主要是面向外部用户的项目查看、数据验收等功能平台，在此基础上将会融合数据管理功能，使公司外部客户人员，方便执行与管理。

前端访问地址: http://ifms.shujiajia.com/routers/login
...
请看 [CONTRIBUTING.md](https://github.com/Armour/intelligent-factory/blob/master/.github/CONTRIBUTING.md)
